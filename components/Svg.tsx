  ...
  return (
    <div>
        {/* <div classNameName="flex items-end  ">
                <div classNameName="box-cube-1 z-[4] ">
                    <svg width="236" height="153" viewBox="0 0 236 153" fill="none">
                        ...
                        <path d="M0.278198 5.70566L113.729 0.541992L235.089 6.53945L113.384 13.2209L0.278198 5.70566Z"
                        ...
                        <defs>
                            ...
                            <linearGradient id="paint2_linear_1_3063" x1="49.5" y1="-33.0004" x2="120.232" y2="10.3047"
                ...
                <div classNameName="box-cube-2 z-[3] right-[90px] bottom-4 relative">
                    <svg width="222" height="233" viewBox="0 0 222 233" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M0.38623 4.86796L112.691 -0.00256348L221.747 6.10784L117.233 9.97951L0.38623 4.86796Z"
                        ...
                        <defs>
                            ...
                            <linearGradient id="paint2_linear_1_3059" x1="121.667" y1="79.5059" x2="192.739" y2="282.18"
                                gradientUnits="userSpaceOnUse">
                                <stop stop-color="#F89E8D" />
                                <stop offset="0.9964" stop-color="#FF6347" />
                            </linearGradient>
                            <linearGradient id="paint3_linear_1_3059" x1="166.5" y1="10" x2="42" y2="3.02483e-06"
                                gradientUnits="userSpaceOnUse">
                ...
                <div classNameName="box-cube-3 z-[2] right-[120px] bottom-6 relative">
                    <svg width="212" height="326" viewBox="0 0 212 326" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            ...
                            <linearGradient id="paint1_linear_1_3056" x1="61.3343" y1="0.710449" x2="61.3343"
                                y2="325.318" gradientUnits="userSpaceOnUse">
                                <stop stop-opacity="0" />
                                <stop offset="1" />
                            </linearGradient>
                            <linearGradient id="paint2_linear_1_3056" x1="125.238" y1="106.08" x2="267.748" y2="349.322"
                                gradientUnits="userSpaceOnUse">
                                <stop stop-color="#F89E8D" />
                                <stop offset="0.9964" stop-color="#FF6347" />
                            </linearGradient>
                                        ...
                                        <div className="mt-1 flex gap-3 items-center justify-center">
                                            <div className="w-6 h-6 rounded-full">
                                                <img className="block w-full h-full rounded-full object-cover"
                                                    src="assets/hero.jpg" alt="flag-logo" />
                                            </div>
