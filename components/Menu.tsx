...
const Menu = () => {
  return (
    ...
    <div className='flex justify-center text-center flex-col  mt-4 rounded-[1.375rem] bg-[#FF7F504A] p-6'>
...
If a letter turns green, you&apos;ve got both the letter and its position correct. A gray letter means its not in the target word at all.</p>
            ...
            <div className='flex justify-center text-center flex-col  mt-4 p-5 bg-[#FF7F504A] rounded-[1.375rem]'>
