...
const Box = () => {
    return (
            ...
            <div className='relative w-full p-14 flex justify-center bg-white'>
                <div className=' flex justify-center items-center  bg-[#FFF] rounded-[1.25rem] max-w-[71.25rem] border-t-[3px] border-blue-400 py-8 shadow-[0px_7px_14px_rgba(0,_0,_0,_0.1)]'>
                ...
                <div className='w-[15rem] h-[3.9375rem]  rounded-[5.625rem] absolute top-6 bg-blue-400 text-[1.77988rem] text-center'>
